...
case $1 in
  ...
  gcov westeros-gl/libwesteros_gl_la-westeros-gl.cpp -o westeros-gl/.libs/ > /dev/null 2>&1
  cd ..
  ../parse-coverage westeros-compositor.cpp.gcov westeros-render-embedded.cpp.gcov westeros-render-gl.cpp.gcov essos/essos.cpp.gcov drm/westeros-gl.c.gcov v4l2/westeros-sink/westeros-sink.c.gcov v4l2/westeros-sink/westeros-sink-soc.c.gcov
  ;;
  *)
  echo "bad platform"
  exit ;;
